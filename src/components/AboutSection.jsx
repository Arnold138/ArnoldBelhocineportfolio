...
const AboutSection = () => {
  ...
  const experiences = useMemo(() => [
    ...
    },
    {
      ...
      description: "Rigueur, discipline et esprit d'équipe acquis au service de la population. Missions de protection, de surveillance et d'intervention rapide dans des contextes critiques.",
      period: "Maintiens de l'ordre",
      date: "2022-2023",
      color: "#1e3a8a",
